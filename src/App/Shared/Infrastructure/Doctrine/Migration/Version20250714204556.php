 ...
 */
final class Version20250714204556 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE equipment_template_property (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, is_required BOOLEAN NOT NULL, template_id UUID DEFAULT NULL, definition_id UUID DEFAULT NULL, PRIMARY KEY(id))');
