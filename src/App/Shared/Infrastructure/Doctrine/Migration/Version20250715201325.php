 ...
 */
final class Version20250715201325 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE equipment (id UUID NOT NULL, status VARCHAR(255) NOT NULL, owner_id_uuid UUID NOT NULL, equipment_template_id UUID DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_D338D5836498FB9F ON equipment (equipment_template_id)');
        $this->addSql('CREATE TABLE equipment_category (id UUID NOT NULL, category_name VARCHAR(128) NOT NULL, parent_category_id UUID DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE equipment_property (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, value_value VARCHAR(128) NOT NULL, equipment_id UUID NOT NULL, template_property_id INT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE equipment_template_property (is_required BOOLEAN NOT NULL, id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, template_id UUID DEFAULT NULL, definition_id UUID DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE equipment_template_property_definition (id UUID NOT NULL, property_type VARCHAR(255) NOT NULL, name_name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
